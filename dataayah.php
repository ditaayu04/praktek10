            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label for="nama" class="col-sm-2 col-form-label">Nama Ayah Kandung</label>
                        <div class="col-sm-10">
                            <input type="text" name="nama" id="nama" class="form-control <?php echo ($error_nama !="" ? "is-invalid" : ""); ?>" placeholder="" value="<?php echo $nama; ?>"> <span class="warning"><?php echo $error_nama ?></span>
                        </div>
                    </div><br>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <span class="warning" ><?php echo $berkebutuhan; ?></span>
                        </div>
                    </div>
